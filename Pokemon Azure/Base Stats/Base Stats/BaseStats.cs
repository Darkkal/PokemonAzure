...
namespace Base_Stats
{
    ...
    public class BaseStat
    {
        ...
        public ushort HPEVYield
        {
            get
            {
                ushort i = EffortYield;
                i &= 0x03;
                return i;
            }
        }

        public ushort ATTKEVYield
        {
            get
            {
                ushort i = EffortYield;
        ...
        public static BaseStat LoadBasePokemon(BinaryReader reader)
        {
            ...
            //Egg Groups
            num = reader.ReadInt32();
            stat.EggGroups = new byte[num];
            for (int i = 0; i < num; i++)
            {
                stat.EggGroups[i] = reader.ReadByte();
            }
